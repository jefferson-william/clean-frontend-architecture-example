...
import TabPanel from '~/next/module/Candidate/components/atoms/TabPanel'
import AddInformationFields from '~/next/module/Candidate/components/molecules/AddInformationFields'
import { Main } from '~/next/module/Candidate/components/pages/Main/styles'
import linkedinImage from '~/next/shared/assets/images/linkedin.png'
import Layout from '~/next/shared/components/templates/Layout'
import { LINKEDIN_IS_SHOW_VARIATION, OPTIMIZE_EXPERIMENTS } from '~/next/shared/constants'
