...
const getMultipleError = (_: any, value: string) => `Found multiple elements with the [name='${value}'] attribute`
const getMissingError = (_: any, value: string) => `Unable to find an element with the [name='${value}'] attribute`
